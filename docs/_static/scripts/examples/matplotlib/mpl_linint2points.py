...
for i, ax in enumerate(axgr):
    ...
    if( i==0 ):
        p = sst.plot.contourf(ax=ax, **common_options,
                              transform=projection, levels=16, extend='neither', add_colorbar=False, add_labels=False)
        ...
        ax.set_title('linint2_points - Bilinear interpolation for 3000 random locations', fontsize=14, fontweight='bold', y=1.04)
