...
class BaseTestClass(metaclass=ABCMeta):
    ...
    tmp_a_float64 = np.linspace(1,
                                _kdepnlatmlon,
                                num=_kdepnlatmlon,
                                dtype=np.float64).reshape((_kdep, _nlat, _mlon))

    tmp_a_float32 = np.linspace(1,
                                _kdepnlatmlon,
                                num=_kdepnlatmlon,
                                dtype=np.float32).reshape((_kdep, _nlat, _mlon))

    tmp_a_int64 = np.linspace(1,
                              _kdepnlatmlon,
                              num=_kdepnlatmlon,
                              dtype=np.int64).reshape((_kdep, _nlat, _mlon))
    ...
    _t_lat = np.linspace(1, _nlatmlon, num=_nlatmlon, dtype=np.float64).reshape(
        (_nlat, _mlon))
